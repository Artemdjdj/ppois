...
Piston::Piston(int diameter_p, int height_p, int compression_height_p, int count_of_cycles_p,
				int weight_p): diameter_(diameter_p), height_(height_p), compression_height_(compression_height_p),
