...
void SpeedometerInKilometers::SetSpeed(int speed) {
    CarSetter::SetSingleValue(speed, "The speed should be bigger then zero!", this->speed_);
}

void SpeedometerInKilometers::SetMileage(int mileage) {
    CarSetter::SetSingleValue(mileage, "The mileage should be bigger then zero!", this->mileage_);
}
...
void SpeedometerInMiles::SetSpeed(int speed) {
    CarSetter::SetSingleValue(static_cast<int>(speed * 0.6), "The speed should be bigger then zero!", this->speed_);
}

void SpeedometerInMiles::SetMileage(int mileage) {
    CarSetter::SetSingleValue(static_cast<int>(mileage * 0.6), "The mileage should be bigger then zero!", this->mileage_);
}
